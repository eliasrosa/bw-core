...
class BwCoreServiceProvider extends ServiceProvider
{
    ...
    private function registerAssets(){
        ...
        // Login guest
        //
        CoreAssets::register(config('bw.admin.url') . '/assets/sb-admin/bower_components/bootstrap/dist',
            __DIR__ . '/../Assets/vendor/sb-admin-2-1.0.8/bower_components/bootstrap/dist', 'guest');

        CoreAssets::register(config('bw.admin.url') . '/assets/sb-admin/dist',
            __DIR__ . '/../Assets/vendor/sb-admin-2-1.0.8/dist', 'guest');

        CoreAssets::register(config('bw.admin.url') . '/assets/sb-admin/bower_components/font-awesome/css',
            __DIR__ . '/../Assets/vendor/sb-admin-2-1.0.8/bower_components/font-awesome/css', 'guest');

        CoreAssets::register(config('bw.admin.url') . '/assets/sb-admin/bower_components/jquery/dist',
            __DIR__ . '/../Assets/vendor/sb-admin-2-1.0.8/bower_components/jquery/dist', 'guest');

        CoreAssets::register(config('bw.admin.url') . '/assets/login',
    ...
    private function registerServiceProviders(){
        ...
        //
        $this->app->register('BW\Util\Assets\AssetsServiceProvider');

        //
        $this->app->register('BW\Util\DataGrid\DataGridServiceProvider');
    }
}
