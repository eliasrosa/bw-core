...
use BW\Util\Relationships\Tag\TagForm;
...
class TagController extends BaseController
{
    ...
    {
        $this->middleware('BW\Util\Relationships\Tag\TagMiddleware');
    }
    ...
    public function index()
    {
        ...
        //
        $lists = Tag::where('relation_id', $relation['id'])->get();
        $relations_menu = \BWAdmin::createRelationshipsMenu(Tag::class, $relation['id']);

        //
        return view('BW::util.relationships.tag.index')
    ...
    public function create()
    {
        ...
        //
        return $this->view('BW::util.relationships.tag.create')
    ...
    public function store(Request $request)
    {
        ...
        //
        $validator = Validator::make(Tag::class, TagForm::class, $request->all(), [
            'name' => 'required',
        ], [], [], $relation['id']);
    ...
    public function edit($id)
    {
        ...
        //
        return $this->view('BW::util.relationships.tag.edit')
            ->with(compact('form', 'relation', 'breadcrumb'));
    }
    ...
    private function redirectToIndex($msg)
    {
        ...
        return redirect()->route('bw.relationships.tag.index', [
    ...
    private function createBreadcrumb($title = null)
    {
        ...
        while(!is_null($relation['parent'])){
            ...
            $breadcrumb[] = [
                ...
                'href'  => route('bw.relationships.tag.index', [
                    'relation_id' => $relation['id']
                ])
            ];
