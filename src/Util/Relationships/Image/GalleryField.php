...
{
    public $type = 'file';
    public $view = 'BW::util.relationships.image.gallery';
    public $relation = [];
    public $ref_id = 0;
    ...
    public function __construct($name, $label, $model)
    {
        ...
        //
        Html::addCSS(asset('/packages/eliasrosa/bw-core/util/relationships/image/gallery.css'));
        Html::addJS(asset('/packages/eliasrosa/bw-core/util/relationships/image/gallery.js'));
